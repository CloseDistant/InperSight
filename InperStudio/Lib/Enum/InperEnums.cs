...
namespace InperStudio.Lib.Enum
{
    ...
    public enum SignalSettingsTypeEnum
    {
        Camera,
        Analog
    }
    public enum EventSettingsTypeEnum
    {
        Marker,
        Output
    }
    public enum AdditionSettingsTypeEnum
    {
        Trigger,
        Video
    }

    public enum RecordSettingsTypeEnum
    {
        Preview,
        Record,
        Stop
    }
    public enum SignalPropertiesTypeEnum
    {
        Camera,
        Analog
    }

    public enum AdditionRecordConditionsTypeEnum
    {
        Immediately,
        Delay,
        AtTime,
